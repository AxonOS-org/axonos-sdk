...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    fx.push(IntentObservation::new_direction(ts(1_000), Direction::Up, 58982, 1, [0; 8]));
    fx.push(IntentObservation::new_direction(ts(2_000), Direction::Right, 55704, 1, [0; 8]));
    fx.push(IntentObservation::new_direction(ts(3_000), Direction::Down, 51099, 1, [0; 8]));
    fx.install();
